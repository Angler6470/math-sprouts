/**
 * Progress Tracking Library for Math Sprouts
 * Persists user performance stats to LocalStorage
 */

const STORAGE_KEY = 'math_sprouts_progress';
...
const DEFAULT_PROGRESS = {
  ...
  perModeStats: {
    balance: { answered: 0, correct: 0 },
    garden: { answered: 0, correct: 0 },
    pollinator: { answered: 0, correct: 0 }
  }
};
